...
<head>
    ...
    <link rel="stylesheet" href="asset/css/sweetalert2-dark.min.css">
    <!-- DataTables -->
 	<link rel="stylesheet" href="asset/plugins/datatables/DataTables-1.11.3/css/dataTables.bootstrap5.min.css') ;?>">
	<link rel="stylesheet" href="asset/plugins/datatables/Responsive-2.2.9/css/responsive.bootstrap5.min.css') ;?>"> 

    <link rel="stylesheet" href="asset/plugins/datatables/StateRestore-1.1.1/css/stateRestore.bootstrap5.min.css">
    <!-- Dark style -->
